...
public final class UserProfileDao_Impl implements UserProfileDao {
  ...
  public UserProfileDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUserProfile = new EntityInsertionAdapter<UserProfile>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `user_profile` (`id`,`name`,`currentStreak`) VALUES (?,?,?)";
      }
  ...
  @Override
  public Object upsertProfile(final UserProfile profile,
      ...
      public UserProfile call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new UserProfile(_tmpId,_tmpName,_tmpCurrentStreak);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object profileExists(final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT COUNT(*) FROM user_profile WHERE id = 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
